...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_2__.mapState)(["navbarColor", "logoColor", "LayoutType"])), {}, {
    user: function user() {
...
var render = function () {
  ...
  return _c("footer", { staticClass: "p-4 text-center" }, [
    ...
    _c("a", { attrs: { href: "https://wa.me/6282299265151" } }, [
                        ...
                        directives: [
                          {
                            name: "show",
                            rawName: "v-show",
                            value: _vm.user.role == route.meta.role,
                            expression: "user.role == route.meta.role",
                          },
                        ],
                        key: i,
